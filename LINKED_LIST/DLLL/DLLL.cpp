...
DLLL::DLLL()    // Constructor
{
    Head = NULL;
    CountNode = 0;
}

void DLLL::InsertFirst(int no)
{
    PNODE newn = NULL;
...
void DLLL::InsertAtPos(int no, int pos)
{
...
void DLLL::Display()        // To display the LL
{
    PNODE temp = Head;
...
int DLLL::Count()        // To count number of nodes in LL
{
    return CountNode;
}
